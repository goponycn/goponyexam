<template>
    <div>
        <el-dialog :close-on-click-modal="false" :close-on-press-escape="false" :before-close="handleCloseRegisterForm"
            :visible.sync="registerFormVisible" width="500px">
            <svg-icon slot="prefix" class="QRcodeIcon" icon-class="QRcode" />
            <div class="register">
                <el-form ref="registerForm" :model="registerForm" :rules="registerRules" class="register-form">
                    <h2 class="mt10 mb15">学员注册</h2>
                        ...
                        <el-col class="gutter-row" :span="16">
                            <el-form-item prop="code" v-if="captchaOnOff">
                                <el-input v-model="registerForm.code" auto-complete="off" placeholder="验证码"
                                    style="width:100%;" @keyup.enter.native="handleRegister">
