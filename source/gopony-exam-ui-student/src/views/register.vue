<template>
	<div>
		<el-dialog :close-on-click-modal="false" :close-on-press-escape="false" :before-close="handleCloseLoginForm"
			:visible.sync="registerFormVisible" width="500px">
			<div class="register">
				<el-form ref="registerForm" :model="registerForm" :rules="registerRules" class="register-form">
					<h3 class="title">小马考试通</h3>
...
<style rel="stylesheet/scss" lang="scss">
	...
	.register {
		...
		align-items: center;
		height: 100%;
		background-image: url("../assets/styles/images/login-background.jpg");
