    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['question:judge:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['question:judge:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['question:judge:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['question:judge:export']">导出</el-button>
      </el-col>
              ...
              <el-col :span="8">
                <el-form-item label="答案">
                  <el-radio-group v-model="form.answer">
                    <el-radio v-for="dict in dict.type.pony_question_judge" :key="dict.value" :label="dict.value">
                      {{dict.label}}
                    </el-radio>
                  </el-radio-group>
                </el-form-item>
...
<script>
  import {
    ...
    addQuestion,
    updateQuestion
  } from "@/api/question/judge";
  // 习题编辑组件
  import QuestionEditor from "@/components/QuestionEditor"

  export default {
    name: "Question",
    dicts: ['sys_normal_disable', 'pony_question_difficulty', 'pony_manual_auto', 'pony_question_judge'],
    components: {
      QuestionEditor
    },
    data() {
    ...
    methods: {
      ...
      /** 导出按钮操作 */
      handleExport() {
        this.download('question/judge/export', {
          ...this.queryParams
