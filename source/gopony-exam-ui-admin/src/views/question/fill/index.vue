    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['question:fill:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['question:fill:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['question:fill:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['question:fill:export']">导出</el-button>
      </el-col>
            ...
            <el-row>
              <el-col :span="24">
                <el-form-item label="题目" prop="content">
                  <question-editor v-model="form.content" :min-height="192" :height="280" />
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="8">
                <el-form-item label="填空数" prop="quantity">
                  <el-input-number v-model="form.quantity" :min="1" :max="10" label="可选数量" style="width:100%">
                  </el-input-number>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="批阅方式" prop="isauto">
                  <el-radio-group v-model="form.isauto" disabled="true">
            ...
            <el-row>
              <el-col :span="24">
                <el-form-item label="答案" prop="answer">
                  <el-input v-model="form.answer" type="textarea" placeholder="请输入答案多个填空用括号()分隔" />
                </el-form-item>
              </el-col>
            </el-row>
          </el-tab-pane>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      /** 导出按钮操作 */
      handleExport() {
        this.download('question/fill/export', {
          ...this.queryParams
