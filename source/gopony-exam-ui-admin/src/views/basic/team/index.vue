...
<script>
import { listTeam, getTeam, delTeam, addTeam, updateTeam,changeTeamStatus } from "@/api/basic/team";
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$modal.confirm('确认要' + text + '"' + row.name + '"吗？').then(function() {
        return changeTeamStatus(row.id, row.status);
      }).then(() => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('basic/team/export', {
        ...this.queryParams
