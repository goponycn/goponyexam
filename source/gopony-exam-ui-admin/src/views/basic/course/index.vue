    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['basic:course:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['basic:course:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listCourse, getCourse, delCourse, addCourse, updateCourse,changeCourseStatus } from "@/api/basic/course";
...
export default {
  ...
  methods: {
    ...
    handleAdd() {
      this.reset();
      getCourse(0).then(response => {
          this.gradeOptions = response.grades;
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('basic/course/export', {
        ...this.queryParams
