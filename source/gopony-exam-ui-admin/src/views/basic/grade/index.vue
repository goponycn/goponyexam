...
<script>
import { listGrade, getGrade, delGrade, addGrade, updateGrade,changeGradeStatus } from "@/api/basic/grade";
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$modal.confirm('确认要' + text + '"' + row.name + '"吗？').then(function() {
        return changeGradeStatus(row.id, row.status);
      }).then(() => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('basic/grade/export', {
        ...this.queryParams
