    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['basic:subject:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['basic:subject:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listSubject, getSubject, delSubject, addSubject, updateSubject,changeSubjectStatus } from "@/api/basic/subject";
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$modal.confirm('确认要' + text + '"' + row.name + '"吗？').then(function() {
        return changeSubjectStatus(row.id, row.status);
      }).then(() => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('basic/subject/export', {
        ...this.queryParams
